export const articleContent = {
    title: "Towards More Reliable Visual Analytics Using Dimensionality Reduction: A Quick Guide for Reading Papers",
    subtitle: "Supplementary material for the paper 'Unveiling High-dimensional Backstage: A Survey for Reliable Visual Analytics with Dimensionality Reduction'",
    sections: [
      {
